...
public class FxAdapter extends RecyclerView.Adapter<FxAdapter.ViewHolder>{
    public FxAdapter(List<Items> cardItemsList, Context context) {

        this.cardItemsList = cardItemsList;
        this.context = context;
    }

    private List<Items> cardItemsList;
...
//        holder.eth_value.setText(String.format("%1$,.2f", crossEth));
        ...
        Items cardItem = cardItemsList.get(position);
        ...
        holder.cardLinearLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(view.getContext(), FxActivity.class);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(View itemView) {
            ...
            btc_value =(TextView) itemView.findViewById(R.id.btc_value);
            eth_value = (TextView)itemView.findViewById(R.id.eth_value);
            currency = (TextView)itemView.findViewById(R.id.textViewCurrency);
            cardLinearLayout = (LinearLayout) itemView.findViewById(R.id.card_linear_layout);
        }
    }
}
