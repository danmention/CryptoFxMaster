...
*/
        ...
        adapter = new FxAdapter(cardItemsList, this);
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            while(keysBTC.hasNext() && keysETH.hasNext()) {
                                ...
                                Items card = new Items(keyBTC, btc_values.getDouble(keyBTC), eth_values.getDouble(keyETH));
                                cardItemsList.add(card);
                            }

                            adapter = new FxAdapter(cardItemsList, getApplicationContext());
                            recyclerView.setAdapter(adapter);
